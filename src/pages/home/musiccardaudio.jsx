...
function MusicAudioCard(params) {
    ...
    return (
        <div className="min-w-36 max-w-40  rounded-md overflow-hidden">
            <div className="group relative w-full after:absolute hover:cursor-pointer after:content-[''] after:top-0 after:left-0 after:h-full after:w-full hover:after:bg-gradient-to-tr hover:after:from-transparent hover:after:via-transparent hover:after:to-black" onClick={updatePlayingSong}>
                <img src={image} alt="music" className="w-full  object-cover h-40" />
